...
var ApiClientBase = /** @class */ (function () {
    function ApiClientBase() {
        this.baseApiUrl = "https://localhost:44335/";
    }
    ...
    ApiClientBase.prototype.transformResult = function (url, response, processor) {
        return processor(response);
    };
    ApiClientBase.prototype.getBaseUrl = function (defaultUrl, baseUrl) {
